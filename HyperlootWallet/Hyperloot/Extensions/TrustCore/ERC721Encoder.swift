...
public final class ERC721Encoder {
    ...
    public static func encodeApprove(approved: Address, tokenId: BigUInt) -> Data {
    ...
    public static func encodeTokenOfOwnerByIndex(owner: Address, index: BigUInt) -> Data {
    ...
    public static func encodeSafeTransferFrom(from: Address, to: Address, tokenId: BigUInt) -> Data {
    ...
    public static func encodeBalanceOf(owner: Address) -> Data {
    ...
    public static func encodeBurn(owner: Address, tokenId: BigUInt) -> Data {
    ...
    public static func encodeSetApprovalForAll(operator: Address, approved: Bool) -> Data {
    ...
    public static func encodeSafeTransferFrom(from: Address, to: Address, tokenId: BigUInt, data: Data) -> Data {
    ...
    public static func encodeMint(to: Address, tokenId: BigUInt, uri: String) -> Data {
    ...
    public static func encodeIsApprovedForAll(owner: Address, operator: Address) -> Data {
    ...
    public static func encodeTransferOwnership(newOwner: Address) -> Data {
